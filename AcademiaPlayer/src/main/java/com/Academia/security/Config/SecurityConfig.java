package com.Academia.security.Config;
...
import com.Academia.security.Auth.AuthFilter;
import com.Academia.security.Auth.JwtUnAuthResponse;


@EnableWebSecurity
@Configuration
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	String [] PUBLIC_END_POINTS = {"/api/v1/auth/login","/api/v1/user/info","/api/v1/user/add", "/api/v1/user", "/api/v1/user/{id}","/api/v1/auth/refresh-token","/api/v1/auth/logout","/api/v1/role/",
			"/api/v1/role/add","/api/v1/role/{id}","/api/v1/user/reset_password",
