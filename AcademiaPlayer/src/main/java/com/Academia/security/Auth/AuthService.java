package com.Academia.security.Auth;
...
import com.Academia.security.User.AccessTokenDto;
import com.Academia.security.Token.JWTResponseDto;
import com.Academia.security.Token.JwtTokenUtils;
import com.Academia.security.User.entity.AppUser;
import com.Academia.security.User.entity.TokenInfo;
import com.Academia.security.User.model.AppUserDetail;
import com.Academia.security.User.repository.UserRepo;
import com.Academia.security.User.service.TokenInfoService;
...
public class AuthService {	
	 ...
	 public TokenInfo createLoginToken(String userName, Long userId) {
			...
			tokenInfo.setUser(userRepo.findByid(userId));
